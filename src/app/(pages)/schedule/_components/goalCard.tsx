...
import { Category } from "../labels/components";
import Label from "../labels/components/label";
      ...
      <div className="px-1 sm:px-3 py-2 flex flex-col gap-2 sm:gap-3">
        <div className="flex sm:flex-row justify-between sm:items-center mb-2 border-b-2 border-slate-600 gap-2 pb-2">
          ...
          <div className="flex justify-center sm:justify-end">
            <Category label={workCard.category.name} icon={workCard.category.icon} color={workCard.category.color} />
          </div>
        </div>
