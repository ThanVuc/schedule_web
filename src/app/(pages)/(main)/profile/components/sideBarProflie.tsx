...
const SideBarProfile = ({ Name, percentage, url, CreateAt, UpdateAt, refetchProfile }: SideBarProfileProps) => {
    ...
    return (
        <div className="w-full px-3 py-6 rounded-xl flex flex-col items-center border-1 border-[#ffff]/10">
            <ChangeAvatarDialog url={url} refetchProfile={refetchProfile} />
            <div className="my-4 text-center">
                <div className="font-bold text-lg text-white">{Name}</div>
            </div>
            <div className="w-full mt-6">
                <p className="font-extralight font-poppins  text-white/50 mb-1 flex justify-between">Hoàn thiện hồ sơ <span className="text-[#14FA61]/70 font-bold text-sm mb-1text-right">{clampedPercentage}%</span></p>
